#!/bin/bash
#SBATCH --job-name=emstats
#SBATCH --nodes=1 
#SBATCH --ntasks=1 
#SBATCH --mem=64G
#SBATCH --time=72:00:00
#SBATCH --output=./output/emstats_%A_%a.out
#SBATCH --error=./errors/emstats_%A_%a.err
#SBATCH --array=0-8

ROOT="/hpc/group/kamaleswaranlab/EmoryDataset/EMR_SuperTables_Fluids/"
STATS_DF_OUTPUT_PATH="/hpc/group/kamaleswaranlab/EmoryDataset/EMR_SuperTables_Fluids/stats"
